...
| 0.19.0 | 1.0 候选 | 第 30 月 | F5 Gröbner 基签名约简（cyclic-6 ℤ₁₃ <5 s 目标） |
| 0.20.0 | 1.0 候选 | 第 33 月 | 常微分方程求解器（一阶/二阶 + 系统 + 级数 + Laplace） |
| 0.21.0 | 1.0 候选 | 第 36 月 | 数论与计算代数（模 GCD + 整数分解 + 素性 + 离散对数 + CRT + 数论函数） |
